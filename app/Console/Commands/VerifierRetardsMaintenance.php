...
class VerifierRetardsMaintenance extends Command
{
     ...
     *     from whatever date the Manager originally set. Appartement::
     *     statutCalcule() doesn't capture this (it only reflects the
     *     *current* sejour/mission/ticket state, never an upcoming one),
     *     so this queries séjours directly instead.
